...
import { 
    getAuth, onAuthStateChanged, signOut, updateProfile, setPersistence, browserLocalPersistence 
} from "https://www.gstatic.com/firebasejs/9.23.0/firebase-auth.js";
import { getStorage, ref, uploadBytes, getDownloadURL } from "https://www.gstatic.com/firebasejs/9.23.0/firebase-storage.js";
import { getFirestore, doc, setDoc, getDoc, collection, getDocs, addDoc, deleteDoc } from "https://www.gstatic.com/firebasejs/9.23.0/firebase-firestore.js";
...
dashboardBtn.addEventListener('click', async ()=>{
    ...
    const snapshot = await getDocs(collection(db, "users", auth.currentUser.uid, "reservas"));
    const data = {};
    ...
    new Chart(ctx,{
        type:'bar',
        data:{labels:Object.keys(data), datasets:[{label:'Reservas', data:Object.values(data), backgroundColor:'#3498db'}]},
