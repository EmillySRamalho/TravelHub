...
// Dashboard (gráfico resumo de reservas)
dashboardBtn.addEventListener('click', async ()=>{
    ...
    new Chart(ctx, {
        ...
        data:{
            ...
            datasets:[{label:'Reservas', data:Object.values(data), backgroundColor:'#3498db'}]
        },
...
reservasBtn.addEventListener('click', async ()=>{
    ...
    const loadReservas = async ()=>{
        ...
        snapshot.forEach(doc=>{
            ...
            reservasList.innerHTML += `
                <div class="card">
                    <h4>Hotel: ${data.hotel || data.voo}</h4>
                    <p>Data: ${d.toLocaleString()}</p>
